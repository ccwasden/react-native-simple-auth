...
//   const ME = 'https://api.tumblr.com/v2/user/info';
  const REQUEST_TOKEN = 'https://api.pinterest.com/oauth/';
  const AUTH = 'https://api.pinterest.com/oauth/';
  const ACCESS_TOKEN = 'https://api.pinterest.com/v1/oauth/token';
  const ME = 'https://api.pinterest.com/v1/me/';
